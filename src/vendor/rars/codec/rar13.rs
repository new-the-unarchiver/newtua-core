...
mod tests {
    use super::{
        DEC_HF0, DEC_HF1, DEC_HF2, DEC_HF3, DEC_HF4, DEC_L1, DEC_L2, EncodeOptions, EncodedToken,
        LongLz, LzPlanState, OldDistLz, POS_HF0, POS_HF1, POS_HF2, POS_HF3, POS_HF4, POS_L1,
        POS_L2, ShortLz, Unpack15, Unpack15Encoder, decode_num_bit_cost,
        decode_num_prefix_is_stable, find_long_lz, find_lz_token, find_old_dist_lz,
        long_lz_buckets, should_lazy_emit_literal, unpack15_decode, unpack15_encode,
    };
